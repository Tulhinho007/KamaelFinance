        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 border-b border-slate-800/80 pb-6">
          <div>
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="px-2.5 py-0.5 text-xs font-medium bg-slate-800 text-slate-400 rounded-md">
          ...
          <button
            ...
            className="inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-slate-900 hover:bg-slate-800 border border-slate-700/70 text-slate-200 text-sm font-medium transition-all shadow-sm hover:border-slate-600 active:scale-95"
          >
            {copied ? (
              <>
                <Check className="w-4 h-4 text-emerald-400" />
                <span className="text-emerald-400 font-semibold">Resumo Copiado!</span>
              </>
            ) : (
              <>
            ...
            return (
              <button
                ...
                className={`relative flex flex-col text-left p-5 rounded-2xl transition-all duration-200 border cursor-pointer ${
                  isActive
                    ? "bg-slate-900/95 border-emerald-500/60 ring-2 ring-emerald-500/20 shadow-xl shadow-emerald-500/5"
                    : "bg-slate-900/40 border-slate-800/80 hover:bg-slate-900/70 hover:border-slate-700/70"
                }`}
              >
                <div className="flex items-center justify-between w-full mb-3">
                  ...
                  <div className="flex items-center gap-1.5">
                    <span className="text-[11px] font-medium text-slate-400 bg-slate-800/60 px-2 py-0.5 rounded-full border border-slate-700/40">
                      {calc.timeEstimate}
                    </span>
                    <span
                ...
                <h3 className={`text-base font-bold mb-1 ${isActive ? "text-white" : "text-slate-200"}`}>
                  {calc.title}
                </h3>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-gradient-to-br from-emerald-950/40 via-slate-900 to-slate-900/90 border border-emerald-500/30 rounded-2xl p-5 relative overflow-hidden">
          ...
          <div className="mt-2 text-xs text-emerald-400/90 flex items-center gap-1 font-medium">
        ...
        <div className="bg-slate-900/80 border border-slate-800 rounded-2xl p-5">
          ...
          <div className="mt-2 text-xs text-teal-400/80 font-medium">
        ...
        <div className="bg-slate-900/80 border border-slate-800 rounded-2xl p-5">
          ...
          <div className="text-2xl sm:text-3xl font-extrabold text-white tracking-tight">
            {(result.monthlyEffectiveRate * 100).toFixed(2)}% <span className="text-sm font-normal text-slate-400">a.m.</span>
          </div>
          <div className="mt-2 text-xs text-slate-400">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        {/* PAINEL DE CONTROLES */}
        <div className="lg:col-span-5 bg-slate-900/90 border border-slate-800 rounded-2xl p-5 sm:p-6 space-y-5">
          <div className="flex items-center justify-between border-b border-slate-800 pb-3">
            <h4 className="font-bold text-white text-base flex items-center gap-2">
              <Calculator className="w-4 h-4 text-emerald-400" /> Parâmetros da Simulação
            </h4>
          ...
          <div>
            <div className="flex justify-between items-center mb-1.5">
              <label className="text-xs font-semibold text-slate-300">Valor Inicial (R$)</label>
              <span className="text-sm font-bold text-emerald-400">{formatBRL(initial)}</span>
            </div>
            <input
              type="number"
              min="0"
              ...
              className="w-full bg-slate-950 border border-slate-700/80 rounded-xl px-3.5 py-2.5 text-sm text-white font-medium focus:outline-none focus:border-emerald-500 transition-colors"
            />
            <input
              type="range"
              min="0"
          ...
          <div>
            <div className="flex justify-between items-center mb-1.5">
              <label className="text-xs font-semibold text-slate-300">Aporte Mensal (R$)</label>
              <span className="text-sm font-bold text-emerald-400">{formatBRL(monthly)}</span>
            </div>
            <input
              type="number"
              min="0"
          ...
          <div>
            <div className="flex justify-between items-center mb-1.5">
              <label className="text-xs font-semibold text-slate-300">Taxa de Juros Anual (% a.a.)</label>
              <span className="text-sm font-bold text-teal-400">{annualRate}% a.a.</span>
            </div>
            <input
              type="number"
              min="0"
              ...
              className="w-full bg-slate-950 border border-slate-700/80 rounded-xl px-3.5 py-2.5 text-sm text-white font-medium focus:outline-none focus:border-teal-500 transition-colors"
            />
            <input
              type="range"
              min="0"
          ...
          <div>
            <div className="flex justify-between items-center mb-1.5">
              <label className="text-xs font-semibold text-slate-300">Prazo de Aplicação (Anos)</label>
              <span className="text-sm font-bold text-sky-400">{years} anos ({years * 12} meses)</span>
            </div>
            <input
              type="range"
              min="1"
        ...
        <div className="lg:col-span-7 bg-slate-900/90 border border-slate-800 rounded-2xl p-5 sm:p-6 flex flex-col justify-between">
          <div>
            <div className="flex items-center justify-between mb-4">
              <div>
                <h4 className="font-bold text-white text-base">Curva Exponencial de Patrimônio</h4>
                <p className="text-xs text-slate-400">Aporte inicial, aportes acumulados e juros compostos</p>
              </div>
              <button
          ...
          <div className="bg-slate-950/60 border border-slate-800/80 rounded-xl p-3.5 mt-4 text-xs text-slate-300 flex items-start gap-2.5">
      ...
      {showTable && (
        <div className="bg-slate-900/90 border border-slate-800 rounded-2xl p-5 overflow-hidden">
          <h4 className="font-bold text-white text-sm mb-3">Detalhamento Anual dos Juros Compostos</h4>
                ...
                {result.timeline
                  ...
                  .map((row) => (
                    <tr key={row.month} className="hover:bg-slate-800/50 transition-colors">
                      <td className="py-2 px-4 font-semibold text-white">{row.label}</td>
                      <td className="py-2 px-4 text-sky-400">{formatBRL(row.investedCapital)}</td>
                      <td className="py-2 px-4 text-teal-400">{formatBRL(row.interestAccumulated)}</td>
                      <td className="py-2 px-4 font-bold text-emerald-400">{formatBRL(row.totalBalance)}</td>
                    </tr>
                  ))}
              </tbody>
            </table>
...
function EmergencyFundView({
  ...
  return (
    <div className="space-y-6">
      {/* CARDS DE KPI */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-gradient-to-br from-sky-950/50 via-slate-900 to-slate-900 border border-sky-500/30 rounded-2xl p-5">
          <div className="flex items-center justify-between text-sky-400 mb-2">
          ...
          <div className="mt-2 text-xs text-sky-300/80 font-medium">
        ...
        <div className="bg-slate-900/80 border border-slate-800 rounded-2xl p-5">
          ...
          <div className="text-2xl sm:text-3xl font-extrabold text-emerald-400 tracking-tight">
            {result.coverageMonths} <span className="text-base font-normal text-slate-400">meses</span>
          </div>
          <div className="mt-2 text-xs text-slate-400">
        ...
        <div className="bg-slate-900/80 border border-slate-800 rounded-2xl p-5">
          ...
          <div className={`text-2xl sm:text-3xl font-extrabold tracking-tight ${
            result.isFullyFunded ? "text-emerald-400" : "text-amber-400"
          }`}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        <div className="lg:col-span-7 bg-slate-900/90 border border-slate-800 rounded-2xl p-5 sm:p-6 space-y-6">
          <div>
            <h4 className="font-bold text-white text-base mb-1">1. Selecione seu Perfil de Trabalho</h4>
            <p className="text-xs text-slate-400 mb-4">A estabilidade da sua fonte de renda determina o número seguro de meses de cobertura.</p>
                ...
                return (
                  <button
                    ...
                    className={`flex flex-col text-left p-4 rounded-xl border transition-all cursor-pointer ${
                      isSelected
                        ? "bg-sky-950/40 border-sky-500/80 ring-2 ring-sky-500/20 text-white"
          ...
          <div className="space-y-4 pt-2 border-t border-slate-800">
            <div>
              <div className="flex justify-between items-center mb-1.5">
                <label className="text-xs font-semibold text-slate-300">Custo Fixo de Vida Mensal (R$)</label>
                <span className="text-sm font-bold text-sky-400">{formatBRL(cost)}</span>
              </div>
              <p className="text-[11px] text-slate-500 mb-2">Aluguel, contas essenciais, supermercado, saúde e parcelas fixas.</p>
              <input
                type="number"
                min="0"
                step="200"
                ...
                className="w-full bg-slate-950 border border-slate-700/80 rounded-xl px-3.5 py-2.5 text-sm text-white font-medium focus:outline-none focus:border-sky-500"
              />
              <input
                type="range"
                min="1000"
            ...
            <div>
              <div className="flex justify-between items-center mb-1.5">
                <label className="text-xs font-semibold text-slate-300">Saldo Atual Guardado na Reserva (R$)</label>
                <span className="text-sm font-bold text-emerald-400">{formatBRL(savings)}</span>
              </div>
              <input
                type="number"
                min="0"
                ...
                className="w-full bg-slate-950 border border-slate-700/80 rounded-xl px-3.5 py-2.5 text-sm text-white font-medium focus:outline-none focus:border-emerald-500"
              />
              <input
                type="range"
                min="0"
        ...
        <div className="lg:col-span-5 bg-slate-900/90 border border-slate-800 rounded-2xl p-5 sm:p-6 flex flex-col justify-between">
          <div>
            <div className="flex items-center justify-between mb-4">
              <h4 className="font-bold text-white text-base">Diagnóstico de Blindagem</h4>
            ...
            <div className="space-y-2 mb-6">
              <div className="flex justify-between text-xs text-slate-400 font-medium">
                ...
                <span className="text-white font-bold">{result.coveragePercentage}%</span>
              </div>
            ...
            <div className="bg-slate-950/80 border border-slate-800/80 rounded-xl p-4 space-y-3">
              <div className="flex items-start gap-2.5">
                ...
                <div>
                  <h5 className="text-xs font-bold text-white uppercase tracking-wider">Recomendação do Consultor</h5>
          ...
          <div className="bg-sky-950/30 border border-sky-500/20 rounded-xl p-3.5 mt-6 text-xs text-sky-200">
...
function DebtAmortizationView({
  ...
  return (
    <div className="space-y-6">
      {/* CARDS DE KPI */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-gradient-to-br from-rose-950/50 via-slate-900 to-slate-900 border border-rose-500/30 rounded-2xl p-5">
        ...
        <div className="bg-slate-900/80 border border-slate-800 rounded-2xl p-5">
          ...
          <div className="text-2xl sm:text-3xl font-extrabold text-white tracking-tight">
            {result.monthsSaved} <span className="text-base font-normal text-slate-400">meses</span>
          </div>
          <div className="mt-2 text-xs text-sky-400/90 font-medium">
        ...
        <div className="bg-slate-900/80 border border-slate-800 rounded-2xl p-5">
          ...
          <div className="text-2xl sm:text-3xl font-extrabold text-white tracking-tight">
            {result.acceleratedMonths} <span className="text-base font-normal text-slate-400">meses</span>
          </div>
          <div className="mt-2 text-xs text-slate-400">
      ...
      {!result.isViable && (
        <div className="bg-rose-950/40 border border-rose-500/50 rounded-2xl p-4 text-xs text-rose-200 flex items-start gap-3">
          <AlertCircle className="w-5 h-5 text-rose-400 shrink-0 mt-0.5" />
          <div>
            <strong className="text-sm font-bold text-rose-300">Atenção ao Valor da Parcela:</strong>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        <div className="lg:col-span-5 bg-slate-900/90 border border-slate-800 rounded-2xl p-5 sm:p-6 space-y-5">
          <div className="flex items-center justify-between border-b border-slate-800 pb-3">
            <h4 className="font-bold text-white text-base">Dados do Financiamento / Dívida</h4>
            <span className="text-xs text-slate-400">Amortização Direta</span>
          </div>

          <div>
            <div className="flex justify-between items-center mb-1.5">
              <label className="text-xs font-semibold text-slate-300">Saldo Devedor Atual (R$)</label>
              <span className="text-sm font-bold text-rose-400">{formatBRL(balance)}</span>
            </div>
            <input
              type="number"
              min="1000"
              ...
              className="w-full bg-slate-950 border border-slate-700/80 rounded-xl px-3.5 py-2.5 text-sm text-white font-medium focus:outline-none focus:border-rose-500"
            />
            <input
              type="range"
              min="10000"
          ...
          <div>
            <div className="flex justify-between items-center mb-1.5">
              <label className="text-xs font-semibold text-slate-300">Taxa de Juros Anual (% a.a.)</label>
              <span className="text-sm font-bold text-amber-400">{annualRate}% a.a.</span>
            </div>
            <input
              type="number"
              min="0"
              ...
              value={annualRate}
              onChange={(e) => setAnnualRate(Math.max(0, Number(e.target.value)))}
              className="w-full bg-slate-950 border border-slate-700/80 rounded-xl px-3.5 py-2.5 text-sm text-white font-medium focus:outline-none focus:border-amber-500"
            />
            <input
              type="range"
              min="3"
          ...
          <div>
            <div className="flex justify-between items-center mb-1.5">
              <label className="text-xs font-semibold text-slate-300">Parcela Mensal Atual (R$)</label>
              <span className="text-sm font-bold text-slate-200">{formatBRL(monthlyPayment)}</span>
            </div>
            <input
              type="number"
              min="100"
              ...
              className="w-full bg-slate-950 border border-slate-700/80 rounded-xl px-3.5 py-2.5 text-sm text-white font-medium focus:outline-none focus:border-slate-500"
            />
          </div>
          ...
          <div className="p-4 bg-emerald-950/20 border border-emerald-500/30 rounded-xl space-y-2">
            <div className="flex justify-between items-center">
              ...
              <span className="text-sm font-extrabold text-emerald-300">+{formatBRL(extraPayment)}</span>
            </div>
            <input
              type="number"
              min="0"
              ...
              className="w-full bg-slate-950 border border-emerald-500/50 rounded-xl px-3.5 py-2.5 text-sm text-white font-medium focus:outline-none focus:border-emerald-400"
            />
            <input
              type="range"
              min="0"
        ...
        <div className="lg:col-span-7 bg-slate-900/90 border border-slate-800 rounded-2xl p-5 sm:p-6 flex flex-col justify-between">
          <div>
            <div className="flex items-center justify-between mb-4">
              <div>
                <h4 className="font-bold text-white text-base">Curva de Desalavancagem da Dívida</h4>
                <p className="text-xs text-slate-400">Comparação do saldo devedor ao longo dos meses</p>
              </div>
              <button
            ...
            <div className="h-72 sm:h-80 w-full">
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={result.schedule} margin={{ top: 10, right: 10, left: -10, bottom: 0 }}>
                  <CartesianGrid strokeDasharray="3 3" stroke="#334155" opacity={0.5} />
                  <XAxis dataKey="month" stroke="#64748b" fontSize={11} tickFormatter={(m) => `Mês ${m}`} />
                  <YAxis
                    stroke="#64748b"
                    fontSize={11}
      ...
      {showSchedule && (
        <div className="bg-slate-900/90 border border-slate-800 rounded-2xl p-5 overflow-hidden">
          <h4 className="font-bold text-white text-sm mb-3">Amostragem do Cronograma de Amortização</h4>
          <div className="overflow-x-auto">
            <table className="w-full text-xs text-left text-slate-300">
              <thead className="bg-slate-950 text-slate-400 uppercase font-semibold border-b border-slate-800">
                <tr>
              ...
              <tbody className="divide-y divide-slate-800">
                {result.schedule.map((row) => (
                  <tr key={row.month} className="hover:bg-slate-800/50 transition-colors">
                    <td className="py-2 px-4 font-semibold text-white">Mês {row.month}</td>
                    <td className="py-2 px-4 text-rose-400">{formatBRL(row.originalBalance)}</td>
                    <td className="py-2 px-4 font-bold text-emerald-400">{formatBRL(row.acceleratedBalance)}</td>
                    <td className="py-2 px-4 text-slate-400">{formatBRL(row.originalInterestPaid)}</td>
                    <td className="py-2 px-4 text-teal-400">{formatBRL(row.acceleratedInterestPaid)}</td>
                  </tr>
                ))}
              </tbody>
            </table>
    ...
    <div className="space-y-6">
      ...
      <div
        className={`rounded-2xl p-6 border transition-all ${
          isCashWinner
            ...
            ? "bg-gradient-to-r from-indigo-950/60 via-slate-900 to-slate-900 border-indigo-500/40"
      ...
      >
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="sm:text-right bg-slate-950/60 p-4 rounded-xl border border-slate-800/80 shrink-0">
            <div className="text-xs text-slate-400 uppercase font-semibold">Vantagem Financeira Líquida</div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-slate-900/80 border border-slate-800 rounded-2xl p-5">
          ...
          <div className="text-2xl sm:text-3xl font-extrabold text-white tracking-tight">
            {installments}x <span className="text-base font-normal text-slate-400">de {formatBRL(result.installmentValue)}</span>
          </div>
          <div className="mt-2 text-xs text-slate-400">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        <div className="lg:col-span-5 bg-slate-900/90 border border-slate-800 rounded-2xl p-5 sm:p-6 space-y-5">
          <div className="flex items-center justify-between border-b border-slate-800 pb-3">
            <h4 className="font-bold text-white text-base">Condições da Compra</h4>
            <span className="text-xs text-slate-400">Custo de Oportunidade</span>
          </div>

          <div>
            <div className="flex justify-between items-center mb-1.5">
              <label className="text-xs font-semibold text-slate-300">Preço Cheio do Produto (R$)</label>
              <span className="text-sm font-bold text-white">{formatBRL(price)}</span>
            </div>
            <input
              type="number"
              min="10"
              ...
              className="w-full bg-slate-950 border border-slate-700/80 rounded-xl px-3.5 py-2.5 text-sm text-white font-medium focus:outline-none focus:border-indigo-500"
            />
          </div>

          <div>
            <div className="flex justify-between items-center mb-1.5">
              <label className="text-xs font-semibold text-slate-300">Desconto Oferecido À Vista (%)</label>
              <span className="text-sm font-bold text-emerald-400">{discount}% ({formatBRL(result.cashDiscountAmount)})</span>
            </div>
            <input
              type="range"
              min="0"
          ...
          <div>
            <div className="flex justify-between items-center mb-1.5">
              <label className="text-xs font-semibold text-slate-300">Quantidade de Parcelas no Cartão</label>
              <span className="text-sm font-bold text-indigo-400">{installments}x de {formatBRL(result.installmentValue)}</span>
            </div>
            <input
              type="range"
              min="1"
          ...
          <div className="grid grid-cols-2 gap-3 pt-2 border-t border-slate-800">
            <div>
              <label className="text-xs font-semibold text-slate-300 block mb-1">Taxa CDI (% a.a.)</label>
              <input
                type="number"
                step="0.25"
                value={cdiRate}
            ...
            <div>
              <label className="text-xs font-semibold text-slate-300 block mb-1">Alíquota IR (%)</label>
              <input
                type="number"
                step="2.5"
                value={taxRate}
        ...
        <div className="lg:col-span-7 bg-slate-900/90 border border-slate-800 rounded-2xl p-5 sm:p-6 flex flex-col justify-between">
          <div>
            <div className="flex items-center justify-between mb-4">
              <div>
                <h4 className="font-bold text-white text-base">Fundo de Oportunidade (Fluxo Mês a Mês)</h4>
                <p className="text-xs text-slate-400">Saldo aplicado rendendo e pagando cada fatura mensal</p>
              </div>
            </div>
